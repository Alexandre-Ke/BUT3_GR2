...
public class Client extends Utilisateur {
	...
	public void setUserId(String userId) throws IllegalFormatException {
		if (!Client.checkFormatUserIdClient(userId)) {
			throw new IllegalFormatException("L'identifiant n'est pas au bon format." + "Format attendu : ex. d.dupont123");
		}
	...
	/**
	 * Fonction qui va vérifier le string d'entrée s'i.l correspond au format
